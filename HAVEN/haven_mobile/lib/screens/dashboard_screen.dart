...
import 'package:haven_mobile/screens/settings_screen.dart';
import 'package:haven_mobile/screens/responder_dashboard.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            tooltip: 'Responder Dashboard (test)',
            icon: const Icon(Icons.map),
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const ResponderDashboard()));
            },
          ),
          IconButton(
            tooltip: 'Quick Exit to decoy',
